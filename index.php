                          ...
                          <div class="image view view-first">
                            ...
                            <div class="mask no-caption">
                              <div class="tools tools-bottom">
                                ...
                                <a onclick="data(<?php echo $id ?>)"><i class="fa fa-link"></i></a>
                                <a onclick="edit(<?php echo $id ?>)"><i class="fa fa-pencil"></i></a>
                                <a onclick="del(<?php echo $id ?>)"><i class="fa fa-times"></i></a>
                              </div>
                            </div>
                          </div>
                          <div class="caption">
                            <p><strong><?php echo $document_title ?></strong>
                            </p>
                            <p><?php echo $name ?></p>
                          </div>
                        </div>
...
$result->free();
    ...
    function data(id) {
        ...
        location.href = "show_data.php?id=" + id;
    }
    function edit(id) {
